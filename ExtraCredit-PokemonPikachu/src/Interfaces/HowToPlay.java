...
public class HowToPlay extends javax.swing.JFrame {
    ...
    public HowToPlay() {
        ...
        texto.setText("""
                        ...
                        El objetivo principal del juego es crear y mantener una relación con
                        tu mascota virtual. La relación siempre empieza en 0 y crece hasta 
                        un  máximo de diez mil (10000). Al alcanzar el estado más alto 
                        (8000 en este caso) se permite agregar un segundo pokémon.
                      
                        Puedes comprar cosas en la tienda para ganar más amistad con tu 
                        pokemon. Y puedes ganar watts (o perderlos), en los minijuegos 
                        que cada pokemon ofrece.
                        """);
    ...
    private void initComponents() {
        ...
        jPanel2.add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 580, 120, 40));

        pachirisuLabel.setText("jLabel4");
        jPanel2.add(pachirisuLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 420, 230, 230));

        jLabel1.setFont(new java.awt.Font("Peace Sans", 0, 48)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(57, 90, 168));
        jLabel1.setText("Cómo se Juega");
        jPanel2.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 20, 390, 80));

        pokemonLabel.setText("jLabel3");
        jPanel2.add(pokemonLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 440, 360, 120));
        ...
        jPanel3.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 100, 480, 320));
